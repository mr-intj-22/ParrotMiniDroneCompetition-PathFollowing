...
MAKECMD         = /opt/MATLAB/R2019b/bin/glnxa64/gmake
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
PRODUCT                 = flightControlSystemlib.a
MAKEFILE                = flightControlSystem.mk
MATLAB_ROOT             = /opt/MATLAB/R2019b
ALT_MATLAB_ROOT         = /opt/MATLAB/R2019b
MASTER_ANCHOR_DIR       = 
START_DIR               = /home/mrintj/MATLAB/projects/examples/parrotMinidroneCompetition-MALEK/work
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 0
COMPUTER                = GLNXA64
...
DEFINES_CUSTOM          = 
SYSTEM_LIBS             = -L"/opt/MATLAB/R2019b/bin/glnxa64" -lfixedpoint -lmwmathutil -lmwipp -lmwsl_AsyncioQueue -lmwsf_runtime -lmwslexec_simlog -lmwcoder_ToAsyncQueueTgtAppSvc -lmwsl_simtarget_instrumentation -lmwsl_simtarget_core -lmwstringutil -lcovrt
...
MODELLIB                  = flightControlSystemlib.a
MODELREF_LINK_LIBS        = 
...
ADD_INCLUDES = \
	...
	-I$(MATLAB_ROOT)/toolbox/vision/include \
