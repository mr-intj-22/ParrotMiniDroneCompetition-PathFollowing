...
#endif
static void mdlInitializeConditions ( SimStruct * S ) { uint8_T * o_o_B_18_2
= ( uint8_T * ) ssGetOutputPortSignal ( S , 1 ) ; ha1ipjbq54 ( o_o_B_18_2 ) ;
...
real32_T * o_B_18_1 = ( real32_T * ) ssGetOutputPortSignal ( S , 0 ) ;
uint8_T * o_o_B_18_2 = ( uint8_T * ) ssGetOutputPortSignal ( S , 1 ) ; if (
tid == 0 ) { flightControlSystemTID0 ( i_lvnv2nqgkq , i_kbv1jfsawh , o_B_18_1
, o_o_B_18_2 ) ; pyvd4pdf3iTID0 ( ) ; } if ( tid == 1 ) {
...
tid ) ) { flightControlSystemTID0 ( i_lvnv2nqgkq , i_kbv1jfsawh , o_B_18_1 ,
o_o_B_18_2 ) ; } if ( ssIsSampleHit ( S , 1 , tid ) ) {
