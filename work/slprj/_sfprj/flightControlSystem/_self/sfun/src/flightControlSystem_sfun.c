  ...
  unsigned int chartFileNumber, const char* specsCksum, int_T method, void *data)
{
  if (chartFileNumber==2) {
    c2_flightControlSystem_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
       ...
       case 2:
        {
          ...
          sf_c2_flightControlSystem_get_check_sum(plhs);
          break;
        }
      ...
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1671698971U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2059370967U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2595834967U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1888663030U);
    } else {
      return 0;
    }
  } else {
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2080639598U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3466981472U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(738020647U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1792167225U);
  }
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(instanceChksum, "sFBqTlbkfMXYKz2mbQb3eqF") == 0) {
          extern const mxArray
            *sf_c2_flightControlSystem_get_eml_resolved_functions_info(void);
          mxArray *persistentMxArray = (mxArray *)
            sf_c2_flightControlSystem_get_eml_resolved_functions_info();
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(tpChksum, "sFBqTlbkfMXYKz2mbQb3eqF") == 0) {
          extern mxArray *sf_c2_flightControlSystem_third_party_uses_info(void);
          plhs[0] = sf_c2_flightControlSystem_third_party_uses_info();
          break;
        }
      }
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(tpChksum, "sFBqTlbkfMXYKz2mbQb3eqF") == 0) {
          extern mxArray *sf_c2_flightControlSystem_jit_fallback_info(void);
          plhs[0] = sf_c2_flightControlSystem_jit_fallback_info();
          break;
        }
      }
     ...
     case 2:
      {
        if (strcmp(tpChksum, "sFBqTlbkfMXYKz2mbQb3eqF") == 0) {
          ...
          const char* encoded_post_codegen_info =
            sf_c2_flightControlSystem_get_post_codegen_info();
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(tpChksum, "sFBqTlbkfMXYKz2mbQb3eqF") == 0) {
          extern mxArray *sf_c2_flightControlSystem_updateBuildInfo_args_info
            (void);
          plhs[0] = sf_c2_flightControlSystem_updateBuildInfo_args_info();
          break;
        }
      }
